...
namespace Ecw.Libs.Forms
{
    ...
    public class DateTimeBox : GenericBox<DateTime?>
    {
        private DateTimeFormat maskAndFormat = DateTimeFormat.DateTime;

        public DateTimeBox() {}


        public DateTimeBox(DateTimeFormat maskAndFormat)
        {
            MaskAndFormat = maskAndFormat;
        }

        [Browsable(true)]
        [DefaultValue(DateTimeFormat.DateTime)]
        public DateTimeFormat MaskAndFormat
        {
            get { return this.maskAndFormat; }
            set
            {
                this.maskAndFormat = value;
        ...
        public new string Mask
        {
            ...
            {
                base.Mask = value;
                MaskAndFormat = DateTimeFormat.Custom;
            }
        }
