...
namespace Ecw.Libs.Forms
{
    ...
    public class TimeSpanBox : GenericBox<TimeSpan?>
    {
        private TimeSpanFormat maskAndFormat = TimeSpanFormat.Time;

        public TimeSpanBox() {}


        public TimeSpanBox(TimeSpanFormat maskAndFormat)
        {
            MaskAndFormat = maskAndFormat;
        }

        [Browsable(true)]
        [DefaultValue(TimeSpanFormat.BigTime)]
        public TimeSpanFormat MaskAndFormat
        {
        ...
        public new string Mask
        {
            ...
            {
                base.Mask = value;
                MaskAndFormat = TimeSpanFormat.Custom;
            }
        }
